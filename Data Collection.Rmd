...
lm.everything<-lm(life_expectancy_female~contraceptive_use_percent_of_women_ages_15_49+
...
summary(lm.everything)
```

```{r, fig.width=10, fig.height=10}
avPlots(lm.everything)
```

```{r}
augment(lm.everything, data=joined_Gapminder_tables) %>% 
